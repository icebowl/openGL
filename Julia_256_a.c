...
sr = color[8][0];sg = color[8][1];sb = color[8][2];
er = color[9][0];eg = color[9][1];eb = color[9][2];
ir = (sr-er)/8;ig = (sg-eg)/8; ib = (sb-eb)/8;
color256[0][0] = color [8][0];
color256[0][1] = color[8][1];
color256[0][2] = color[8][2];
for (n = 1; n < 8; n ++){
...
printf ("%f %f %f ", sr,sg,sb);
printf ("%f %f %f ", er,eg,eb);
