...

{
    ...
    glClear( GL_COLOR_BUFFER_BIT| GL_DEPTH_BUFFER_BIT)//include header file for glfw library so that we can use OpenGL
   ...
   // int     width, height;
    ...
    if( !glfwOpenWindow( 512, // width of window
                         ...
                         512, //height of window
                          ...
                          0,  //alphabits//include header file for glfw library so that we can use OpenGL
